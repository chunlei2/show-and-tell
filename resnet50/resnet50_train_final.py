...
from resnet50_utils import clip_gradient, save_accuracy_checkpoint, save_checkpoint, adjust_learning_rate, compute_accuracy, AverageMeter
from resnet50_models import Encoder, Decoder
from resnet50_final_dataset import CaptionDataset

print('This is resnet50 with fine tuned last two layer')
