...
class Encoder(nn.Module):
    """
    Encoder, which by default sets the output channel as 2048 because of pretrained resnet101 structure.
    """
    ...
    def fine_tune(self, fine_tune=True):
        ...
        for c in list(self.resnet.children())[7:]: # Delete a block because of memory error
